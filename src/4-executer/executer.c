...
/*   Updated: 2024/02/20 12:58:03 by fschuber         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void *execute_node(t_bin_tree_node *node, t_program_data *program_data)
{
	if (node->val[0]->type == TOK_BUILTIN)
		execute_builtin(node, program_data);
	return NULL;
}
